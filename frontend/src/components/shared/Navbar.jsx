                    ...
                    <ul className="flex font-medium items-center gap-5 text-white">
                        {user && user.role === 'recruiter' ? (
                            ...
                            <>
                                ...
                                <li>
                                    <Link to="https://react-ai-resume-builder-praveen.vercel.app/">AI Resume Builder</Link>
                                </li>
                                <li>
                                    <Link to="http://localhost:8501/">ATS Checker</Link>
                                </li>
                            </>
                        )}
                    </ul>
                                    ...
                                    <div className="flex flex-col my-2 text-gray-700">
                                        {user?.role === 'student' && (
                                            <div className="flex w-fit items-center gap-2 cursor-pointer">
                                                <User2 />
                                                <Link to="/profile">
                                                    <Button variant="link" className="text-[#6A38C2] hover:text-[#F83002]">
                                                        View Profile
                                                    </Button>
                                                </Link>
                                            </div>
